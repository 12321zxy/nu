...
$(document).ready(function(){
	...
	$('.questions-arrows .left-arrow').click(function(){
	    $(".questions-carousel").slick('slickPrev');
	});

	$('.questions-arrows .right-arrow').click(function(){
	    $(".questions-carousel").slick('slickNext');
	});
});
...
document.addEventListener("DOMContentLoaded", function(){
	document.querySelectorAll('.faq-block-content-title').forEach(heading => {
		heading.addEventListener('click', toggleExpanderArticle);
	});

	function toggleExpanderArticle(event){
			document.querySelectorAll('.faq-block-content').forEach(article => {
...
window.addEventListener("load",function(){
	var menu_buttons = document.querySelectorAll('.nav-mobile-button');
	menu_buttons.forEach(function(element){
...
if (window.screen.width <= 767) {
	$(document).ready(function(){
		$('.what-content .what-carousel').slick({
			slidesToShow: 1,
			slidesToScroll: 1,
			arrows: false,
			infinite: true,
		...
		$('.what-arrows .left-arrow').click(function(){
			$(".what-carousel").slick('slickPrev');
		});
	
		$('.what-arrows .right-arrow').click(function(){
			$(".what-carousel").slick('slickNext');
		});
	});
}
...
if (window.screen.width <= 1023) {
	$(document).ready(function(){
		$('#videos .container .videos-wrapper .lastest-videos').slick({
			slidesToShow: 1,
			slidesToScroll: 1,
			arrows: false,
			infinite: true,
		...
		$('.video-arrows .left-arrow').click(function(){
			$(".lastest-videos").slick('slickPrev');
		});

		$('.video-arrows .right-arrow').click(function(){
			$(".lastest-videos").slick('slickNext');
		});
	});
} 
...
window.addEventListener("load",function(){
	document.querySelector('#whats .tab-1').addEventListener('click',changeContentW_1);
	document.querySelector('#whats .tab-2').addEventListener('click',changeContentW_2);
	document.querySelector('#whats .tab-3').addEventListener('click',changeContentW_3);
});

function changeContentW_1(){
	remove_all_class('show-w');
	document.querySelector('#whats .tab-1').classList.add('show-w');
	document.querySelector('#whats .content-tab-1').classList.add('show-w');
	document.querySelector('#whats .image-tab-1').classList.add('show-w');
};

function changeContentW_2(){
	remove_all_class('show-w');
	document.querySelector('#whats .tab-2').classList.add('show-w');
	document.querySelector('#whats .content-tab-2').classList.add('show-w');
	document.querySelector('#whats .image-tab-2').classList.add('show-w');
};

function changeContentW_3(){
	remove_all_class('show-w');
	document.querySelector('#whats .tab-3').classList.add('show-w');
	document.querySelector('#whats .content-tab-3').classList.add('show-w');
	document.querySelector('#whats .image-tab-3').classList.add('show-w');
};

function remove_all_class(selector){
...
window.addEventListener("load",function(){
	document.querySelector('#how .tab-1').addEventListener('click',changeContent_1);
	document.querySelector('#how .tab-2').addEventListener('click',changeContent_2);
	document.querySelector('#how .tab-3').addEventListener('click',changeContent_3);
});

function changeContent_1(){
	remove_all_class('show');
	document.querySelector('#how .tab-1').classList.add('show');
	document.querySelector('#how .content-tab-1').classList.add('show');
	document.querySelector('#how .image-tab-1').classList.add('show');
};

function changeContent_2(){
	remove_all_class('show');
	document.querySelector('#how .tab-2').classList.add('show');
	document.querySelector('#how .content-tab-2').classList.add('show');
	document.querySelector('#how .image-tab-2').classList.add('show');
};

function changeContent_3(){
	remove_all_class('show');
	document.querySelector('#how .tab-3').classList.add('show');
	document.querySelector('#how .content-tab-3').classList.add('show');
	document.querySelector('#how .image-tab-3').classList.add('show');
};
...
window.addEventListener("scroll", function() {activeSectionTitle()});

function activeSectionTitle() {
	var mainVideosSection = document.querySelector("#main-videos").offsetTop;
	var whatSection = document.querySelector("#what").offsetTop;
	var howSection = document.querySelector('#how').offsetTop;
	var howNubankSection = document.querySelector("#how-nubank").offsetTop;
	var whatsSection = document.querySelector("#whats").offsetTop;
	var otherOption = document.querySelector("#options").offsetTop;
	var marketsSection = document.querySelector("#markets").offsetTop;
	//var videosSection = document.querySelector("#videos").offsetTop;
	var questionsSection = document.querySelector("#questions").offsetTop;
	var reader = document.querySelector(".reader-section-title");
	var scrollPosition = document.documentElement.scrollTop + 60;
	// if(scrollPosition >= 0 && scrollPosition < mainVideosSection ){
	// 	reader.innerText = "Menu";
	// }
	// else if(scrollPosition >= mainVideosSection && scrollPosition < whatSection){
	// 	reader.innerText = "Como funciona a Bolsa";
	// }
	// else if(scrollPosition >= whatSection && scrollPosition < howSection){
	// 	reader.innerText = "Investir em ações";
	// }
	// else if(scrollPosition >= howSection && scrollPosition < howNubankSection){
	// 	reader.innerText = "Por onde começar?";
	// }
	// else if(scrollPosition >= howNubankSection && scrollPosition < whatsSection){
	// 	reader.innerText = "E no Nubank?";
	// }
	// else if(scrollPosition >= whatsSection && scrollPosition < otherOption){
	// 	reader.innerText = "É pra mim?";
	// }
	// else if(scrollPosition >= otherOption && scrollPosition < marketsSection){
	// 	reader.innerText = "Outras opções";
	// }
	// else if(scrollPosition >= marketsSection && scrollPosition < questionsSection){
	// 	reader.innerText = "Ações em cada mercado";
	// }
	// else if(scrollPosition >= videosSection && scrollPosition < questionsSection){
	// 	reader.innerText = "Vídeos";
	// }
	// else {
	// 	reader.innerText = "Perguntas";
	// }
}
...
function onYouTubeIframeAPIReady() {
	...
	player8 = new YT.Player('player10', {
		height: '360',
		width: '640',
		host: 'https://www.youtube.com',
		videoId: 'Oo80fq3kSqo',
...
window.addEventListener("scroll", function(){
	insertYoutubeIframe1();
	insertYoutubeIframe2();
	insertYoutubeIframe3();
	insertYoutubeIframe4();
	insertYoutubeIframe5();
	insertYoutubeIframe6();
	insertYoutubeIframe7();
	insertYoutubeIframe8();
	insertYoutubeIframe9();
	insertYoutubeIframe10();
});

function insertYoutubeIframe1(){
	let videoContainer = $(".main-video");
...
function insertYoutubeIframe2(){
	let videoContainer = $("*.video")[0];
...
function insertYoutubeIframe3(){
	let videoContainer = $("* .video")[1];
...
function insertYoutubeIframe4(){
	let videoContainer = $("*.video")[2];
...
function insertYoutubeIframe10(){
	let videoContainer = $("*.video")[2];
...
$(document).ready(function(){
	...
	function subscribe_newsletter_invest() {
		//var URL = "http://localhost/wp-admin/admin-ajax.php?action=subscribe_newsletter";
